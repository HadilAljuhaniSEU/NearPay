...
import VideoTemplate, { SCENE_DURATIONS } from './video/VideoTemplate';
...
function ControlBar({
  ...
  return (
    ...
    >
      ...
      <div className="text-xl text-white/60 font-mono tabular-nums shrink-0" dir="ltr">
...
export default function VideoWithControls() {
  ...
  // Export path: no interactive wrapper, audio unmuted
